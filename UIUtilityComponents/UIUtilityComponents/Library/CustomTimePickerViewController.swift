...
public protocol CustomTimePickerViewControllerDelegate: AnyObject {
    
    func customTimePickerDidSet(_ viewController: CustomTimePickerViewController, result: CustomTimePickerResult)
    func customTimePickerDidCancel(_ viewController: CustomTimePickerViewController)
}

@objc protocol CustomTimePickerViewControllerInteraction: AnyObject {
    
    func didTapOkay()
    func didTapCancel()
}

public class CustomTimePickerViewController: UIViewController {
    ...
    var result: CustomTimePickerResult {
        var result = CustomTimePickerResult()
    ...
    public weak var delegate: CustomTimePickerViewControllerDelegate?
    public var theme: CustomTheme = .dark
...
extension CustomTimePickerViewController: CustomTimePickerViewControllerInteraction {
    
    func didTapOkay() {
        delegate?.customTimePickerDidSet(self, result: result)
    }
    
    func didTapCancel() {
        delegate?.customTimePickerDidCancel(self)
    }
}
